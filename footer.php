          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="footer-social">
                <ul>
                  <li>
                    <a target="_blank" href="<?php global $comet; echo $comet['facebook-url']; ?>"><i class="ti-facebook"></i></a>
                  </li>
                  <li>
                    <a target="_blank" href="<?php global $comet; echo $comet['instagram-url']; ?>"><i class="ti-twitter-alt"></i></a>
                  </li>
                  <li>
                    <a target="_blank" href="<?php global $comet; echo $comet['linkedin-url']; ?>"><i class="ti-linkedin"></i></a>
                  </li>
                  <li>
                    <a target="_blank" href="<?php global $comet; echo $comet['twitter-url']; ?>"><i class="ti-instagram"></i></a>
                  </li>
                  <li>
                    <a target="_blank" href="<?php global $comet; echo $comet['dribbble-url']; ?>"><i class="ti-dribbble"></i></a>
                  </li>
                </ul>
              </div>
            </div>
