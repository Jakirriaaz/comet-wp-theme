<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Comet Theme Options', 'redux-framework-demo' ),
        'page_title'           => __( 'Comet Theme Options', 'redux-framework-demo' ),
   ...
   Redux::setArgs( $opt_name, $args );
    ...
    Redux::setSection( $opt_name, array(
        'title'     => __('General Settings', 'comet'),
        'id'        => 'general-settings',
        'fields'    => array(
            array(
                'title'     => __('Logo Light', 'comet'),
                'id'        => 'logo-light',
                'type'      => 'media',
                'default'   => array(
